...
- [**CONTENT_GUIDE.md**](guides/CONTENT_GUIDE.md) - Complete guide to all ships, modules, drones, and content
- [**GAMEPLAY_DEMOS.md**](guides/GAMEPLAY_DEMOS.md) - Gameplay demonstration guides

### 👨‍💻 [Development](development/)
Developer documentation, API reference, and implementation details.
...
- [**ASTROX_RESEARCH.md**](research/ASTROX_RESEARCH.md) - Research on Astrox Imperium's approach

### 🧪 [Testing](testing/)
Test documentation, coverage reports, and test guides.
...
1. Place it in the appropriate subject folder
